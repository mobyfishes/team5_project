...
// The @Entity annotation designates this class as a JPA Entity class representing the UserPhoto table in the UsersVideosDB database.
@Entity
...
public class UserPhoto implements Serializable {
    ...
    of the UserPhoto table in the UsersVideosDB database.
    ========================================================
     */
    ...
    represent a row in the UserPhoto table in the UsersVideosDB database.
    =================================================================
     */
    public UserPhoto() {
    }
