...
// The @Entity annotation designates this class as a JPA Entity class representing the User table in the UsersVideosDB database.
@Entity
...
public class User implements Serializable {
    ...
    of the User table in the UsersVideosDB database.
    ========================================================
     */
    ...
    @OneToMany(mappedBy = "userId")
    private Collection<Meeting> userMeetingCollection;

    /*
    ===============================================================
    Class constructors for instantiating a User entity object to
    represent a row in the User table in the UsersVideosDB database.
    ===============================================================
     */
    public User() {
    }
    ...
    public Collection<Meeting> getUserVideoCollection() {
        return userMeetingCollection;
    }

    public void setUserVideoCollection(Collection<Meeting> userMeetingCollection) {
        this.userMeetingCollection = userMeetingCollection;
    }
